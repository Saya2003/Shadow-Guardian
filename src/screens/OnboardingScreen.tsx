        ...
        {step === 3 && (
          <View className="items-center space-y-6">
            ...
            <View className="flex-row justify-center gap-2 my-8">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <View key={i} className="w-10 h-14 bg-surface border border-border rounded-xl items-center justify-center">
                   <Text className="text-xl font-bold text-muted-foreground">0</Text>
                </View>
              ))}
            </View>
        ...
        {step === 4 && (
          <View className="space-y-6">
            ...
            <View className="space-y-3">
              ...
              <TouchableOpacity className="w-full h-14 border-dashed border-2 border-border rounded-2xl items-center justify-center">
                <Text className="text-muted-foreground font-medium">+ Add from Contacts</Text>
              </TouchableOpacity>
            </View>
